...
\begin{figure}[h]
\includegraphics[width=0.49\textwidth]{{dsdt_y_eic1_W_12.5}.pdf}
\includegraphics[width=0.49\textwidth]{{dsdt_y_eic2_W_12.5}.pdf}
...
Only points generated up to $2.5$ GeV are considered in the fits.}
\label{fig:dsigmadt}
\end{figure}
