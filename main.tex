...
The exponential dependence of Eq.~(\ref{eq:bdef}) allows us to express the extrapolated value of the differential cross section at $t=0$ as
\beq
...
\begin{figure}[h]
\includegraphics[width=0.45\textwidth]{{dsdt_y_eic1_W_11.5}.pdf}
\includegraphics[width=0.45\textwidth]{{dsdt_y_eic2_W_11.5}.pdf}
\includegraphics[width=0.45\textwidth]{{dsdt_y_eic1_W_21.5}.pdf}
\includegraphics[width=0.45\textwidth]{{dsdt_y_eic2_W_21.5}.pdf}
\includegraphics[width=0.45\textwidth]{{dsdt_y_eic1_W_35.5}.pdf}
\includegraphics[width=0.45\textwidth]{{dsdt_y_eic2_W_35.5}.pdf}
...
{\color{red} (DO IT IN THE SAME WAY FOR THE $J/\psi$ FIGURE (where tmin term is neglected so far))}.
